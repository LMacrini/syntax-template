...
export default function ProfileHero(props) {
    ...
    return (
        <Container className={twJoin('!py-0', show_gradient ? gradient : '')} style={{ height: '500px' }}>
            ...
            <div
                ...
                <div
                    className={twMerge(
                        ...
                        show_back_drop ? 'my-16 md:my-20 py-8 md:py-12 px-10 md:px-16' : 'my-8 md:my-10 py-8 md:py-12'
                    )}>
                    {show_title ? (
                        <div className='relative lg:w-full md:max-w-2xl lg:max-w-3xl'>
                            <h1 className='text-2xl lg:text-3xl 2xl:text-4xl leading-tight'>{title}</h1>
                        </div>
                    ) : null}
                    {show_back_drop ? (
                        <div
