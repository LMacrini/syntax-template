                    ...
                    <div className='mt-10 lg:col-span-7 lg:mt-0'>
                        <dl className='space-y-10'>
                            {items.map((item, index) => (
                                <div key={index}>
                                    <dt className='text-base font-semibold leading-7 md:text-lg'>
                                        <SafeHtml value={item.title} />
                                    </dt>
                                    <dd className='mt-2 text-base leading-7 text-text-color-90'>
            ...
            <div className='px-6 mx-auto max-w-7xl lg:px-8'>
                <div className='max-w-4xl mx-auto'>
                    ...
                    <dl className='mt-10 space-y-6'>
                        {items.map((item, index) => (
                            <Disclosure as='div' key={index} className='pt-6 border-t-[1px] border-neutral-400'>
                                {({ open }) => (
                                    <>
                                        <dt>
                                            <Disclosure.Button className='flex items-start justify-between w-full text-left  focus:outline-none group'>
                                                ...
                                                <span className='flex items-center ml-6 h-7'>
                                                    {open ? (
                                                        <HiMinusSm className='w-6 h-6' aria-hidden='true' />
                                                    ) : (
                                                        <HiPlusSm className='w-6 h-6' aria-hidden='true' />
                                                    )}
                                                </span>
                                            </Disclosure.Button>
                                        </dt>
