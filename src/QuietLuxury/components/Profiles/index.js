        ...
        if (layout === 'list') {
                ...
                <div key={index} className='w-full flex justify-between items-start space-x-12'>
                    ...
                    <div className='flex-grow h-44 flex flex-col'>
                        ...
                        <Link
                            ...
                            target='_self'
                            className='inline-block w-fit rounded-md px-3 py-1.5 text-sm sm:text-base font-medium bg-link-color-20 text-link-color hover:bg-link-color-10'>
            ...
            return (
                <Link
                    ...
                    <div className='w-full h-20 px-4 py-3 relative bg-text-color-10 group-hover:bg-text-color-0'>
