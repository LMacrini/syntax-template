                            ...
                            return (
                                <div key={index} className='relative flex flex-col gap-8 isolate lg:flex-row'>
                                    <div className='relative aspect-[16/9] sm:aspect-[2/1] lg:aspect-square lg:w-64 lg:shrink-0'>
                                        ...
                                        <div className='absolute inset-0 rounded-2xl ring-1 ring-inset ring-text-color-20' />
                                    </div>
                                    <div>
                                        <div className='relative max-w-xl group'>
                                            <div className='mt-3'>
                                                <h3 className='text-xl font-semibold leading-8'>{stripTags(title)}</h3>
                                                {subtitle ? (
                                                    <p className='mt-1 text-lg leading-6 text-text-color-80'>
                                                        {stripTags(subtitle)}
                                                    </p>
                                                ) : null}
                                            </div>
                                            {paragraphs ? (
                                                <SafeHtml
                                                    value={paragraphs}
                                                    className='mt-5 text-base leading-6 line-clamp-4 text-text-color-90'
                                                />
                                            ) : null}
                                            {link ? (
                                                <Link
