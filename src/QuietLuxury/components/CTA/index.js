...
export default function CTA({ block, website }) {
    ...
    return (
        <Container className='!py-0 flex flex-col lg:flex-row'>
            ...
            <div className='flex flex-col justify-center w-full px-24 py-24 lg:w-1/2'>
                <div className='2xl:px-24'>
                    <SafeHtml as='div' value={pretitle} className='text-base font-semibold leading-7' />
                    <SafeHtml as='h2' value={title} className='mt-2 text-3xl font-bold tracking-tight sm:text-4xl' />
