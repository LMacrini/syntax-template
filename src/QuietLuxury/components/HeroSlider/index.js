            ...
            <div
                ...
                <div className='relative lg:w-full lg:max-w-2xl'>
                    <div className='relative'>
                        <div>
                            {pretitle ? (
                                <SafeHtml value={pretitle} as='h2' className='mb-1 lg:mb-3 text-xl sm:text-2xl' />
                            ) : null}
                            <SafeHtml
                                as='h1'
...
export default function HeroSlider(props) {
    ...
    const { bg_size = 'full', slider_indicator: showIndicator = true, ...properties } = block.getBlockProperties();
    ...
    if (!items.length) return null;
        ...
        return (
            <Container className='!py-0'>
                <div className={bg_size !== 'full' ? 'relative max-w-7xl mx-auto rounded-lg overflow-hidden' : ''}>
