        ...
        <form
            ...
            <div className='max-w-full mx-auto lg:mr-0 lg:max-w-lg px-6 lg:px-0'>
                ...
                <div className='flex justify-end mt-8'>
                    <button
                        type='submit'
                        className='rounded-md bg-primary-200 px-3.5 py-2.5 text-center text-sm font-semibold text-primary-800 shadow-sm hover:bg-primary-800 hover:text-primary-300 border border-primary-100 transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'>
