...
export default function Hero(props) {
    ...
    return (
        <Container className={twJoin('!py-0', show_gradient ? gradient : '')} style={{ height: min_height }}>
            {banner && (
            ...
            <div
                ...
                <div
                    ...
                    <div className='relative lg:w-full md:max-w-2xl lg:max-w-3xl xl:max-w-4xl 2xl:max-w-5xl'>
                        <div className='relative'>
                            <div>
                                ...
                                <SafeHtml
                                    as='h1'
                                    className='text-2xl font-bold tracking-tight sm:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl'
                                    value={title}
                                />
                                {subtitle ? (
                                    <SafeHtml
                    ...
                    {show_back_drop ? (
                        <div
                            className='absolute w-full h-full top-0 left-0 text-text-color-10 opacity-80 rounded-2xl'
                            style={{ zIndex: -1 }}></div>
                    ) : null}
                </div>
            </div>
