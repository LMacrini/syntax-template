            ...
            <div className='mb-4'>
                <form className='flex max-w-xl md:mx-auto' onSubmit={handleSubmit}>
                    <div className='w-full'>
                        ...
                        <div className='relative h-full'>
                            ...
                            <input
                                ...
                                autoComplete='email'
                                required
                                className='block w-full px-3 py-4 pl-11 text-base bg-text-color-0 placeholder:text-text-color-50 border border-text-color-20 rounded-l-xl focus:ring-2 focus:ring-inset focus:ring-indigo-600'
                    ...
                    <div>
                        <input
                            type='submit'
                            className='w-full px-4 py-4 text-base font-medium text-center text-primary-800 bg-primary-300 border border-primary-300 cursor-pointer rounded-r-xl hover:bg-primary-200 focus:outline-none focus:ring-2 focus:ring-indigo-600'
