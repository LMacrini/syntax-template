            ...
            <ContentWrapper hasTextContent={hasTextContent} hasMediaContent={hasMediaContent} alignmentH={alignmentH}>
                ...
                <div
                    ...
                    <div
                        ...
                        <SafeHtml
                            as='h1'
                            className='text-2xl font-bold tracking-tight lg:text-2xl xl:text-3xl 2xl:text-4xl'
                            value={title}
                        />
                        {subtitle ? (
                            <SafeHtml value={subtitle} as='h3' className='mt-4 text-lg leading-8 lg:text-xl' />
                        ) : null}
