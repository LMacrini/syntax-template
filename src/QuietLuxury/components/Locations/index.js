...
import { getLocationsFromInput, getAddressesFromCards } from '../_utils/location';
import Map from './map';
                        ...
                        <div className='w-full lg:w-2/5'>
                            ...
                            {dateRange ? (
                                <div className='mt-4 flex items-center space-x-2.5'>
                                    ...
                                    <p className='text-base md:text-lg lg:text-xl text-text-color-70'>{dateRange}</p>
                                </div>
                            ) : null}
                            {contact ? (
                                <div className='mt-4 flex items-center space-x-2.5'>
        ...
        <div className='px-6 mx-auto max-w-7xl lg:px-8 lg:flex space-y-6 lg:space-y-0 lg:space-x-0'>
            <div className='w-full lg:w-2/5 space-y-4 divide-y divide-text-color-40'>
                {locations.map((location, index) => {
                    ...
                    return (
                        <div key={index} className={twJoin('pl-2 pb-4 relative group', index > 0 ? 'pt-6' : 'pt-2')}>
                            {title ? (
